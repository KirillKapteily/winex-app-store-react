...
function App() {
  ...
  const [transparency, setTransparency] = useState(localStorage.getItem("transparency") || "transparent" );
  useEffect(() => {
      ...
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="/search" element={<Search/>} />
           <Route path="/settings" element={<Settings transparency={transparency} setTransparency={setTransparency}/>} />
